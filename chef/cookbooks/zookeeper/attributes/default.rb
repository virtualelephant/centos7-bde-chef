...
default[:zookeeper][:home_dir]		 = '/opt/mesosphere/zookeeper'
...
default[:zookeeper][:zookeeper_service_name] = 'zookeeper'
default[:zookeeper][:package_name] = 'mesosphere-zookeeper'
